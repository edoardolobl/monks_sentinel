...
class GTMAnalysisServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadAndAnalyze = channel.stream_unary(
                '/gtm.analysis.v1.GTMAnalysisService/UploadAndAnalyze',
                request_serializer=gtm__analysis__pb2.FileUploadRequest.SerializeToString,
                response_deserializer=gtm__analysis__pb2.AnalysisResponse.FromString,
                _registered_method=True)
...
class GTMAnalysisServiceServicer(object):
    ...
    def UploadAndAnalyze(self, request_iterator, context):
...
def add_GTMAnalysisServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadAndAnalyze': grpc.stream_unary_rpc_method_handler(
                    servicer.UploadAndAnalyze,
                    request_deserializer=gtm__analysis__pb2.FileUploadRequest.FromString,
                    response_serializer=gtm__analysis__pb2.AnalysisResponse.SerializeToString,
            ),
...
class GTMAnalysisService(object):
    ...
    @staticmethod
    def UploadAndAnalyze(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/gtm.analysis.v1.GTMAnalysisService/UploadAndAnalyze',
            gtm__analysis__pb2.FileUploadRequest.SerializeToString,
            gtm__analysis__pb2.AnalysisResponse.FromString,
            options,
            channel_credentials,
            insecure,
